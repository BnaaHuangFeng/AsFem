...
private:
    ...
    vector<int> m_subelmtdofsid;/**< for local sub-elemental nodes' gloabl ids, start from 0 (Hf: from 1)*/
    ...
    LocalElmtSolution m_local_elmtsoln;/**< for the local element(Hf: a qpoint) solution (U,V,a, and their grad) */
